...
var tempJSON = [
  ...
  },
  {
    ...
    "samples":[
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/localsearch_control.js"], "sampleName":"Local Search Control", "tags": "Localsearch, Maps"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/localsearch_control_results.js"], "sampleName":"Local Search Control Results", "tags": "Localsearch, Maps, resultList"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/localsearch_control_link_target.js"], "sampleName":"Local Search Control Link Target", "tags": "Localsearch, Maps, linkTarget"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/localsearch_control_search_form_hint.js"], "sampleName":"Local Search Control Search Form Hint", "tags": "Localsearch, Maps, searchFormHint"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/local_search_control_callbacks.js"], "sampleName":"Local Search Control Callbacks", "tags": "Localsearch, Maps, onIdleCallback, onSearchCompleteCallback, onGenerateMarkerHtmlCallback, onMarkersSetCallback"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/local_search_control_suppress_initial_result_selection.js"], "sampleName":"Local Search Control Suppress Initial Result", "tags": "Localsearch, Maps, suppressInitialResultSelection"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/local_search_control_suppress_zoom_to_bounds.js"], "sampleName":"Local Search Control Suppress Zoom", "tags": "Localsearch, Maps, suppressZoomToBounds"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/local_search_control_zoom_limit.js"], "sampleName":"Local Search Control Zoom Limit", "tags": "Localsearch, Maps, zoomLimit"},
      // {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/local_search_control_icons.js"], "sampleName":"Local Search Control Icons", "tags": "Localsearch, Maps, Icons, Pins, Labels"},
      {"boilerplateLoc":"samples/boilerplateHTML/ajaxapis.html", "files":["samples/js/search/localsearch/localsearch_control_small.js"], "sampleName":"Local Search Control Separate Results Small", "tags": "Localsearch, Maps"},
